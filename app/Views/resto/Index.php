...
<body>
	...
	<div id="page">
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 text-center logo-wrap">
						<div id="fh5co-logo"><a href="<?= base_url('/Home'); ?>">Nelongso Group</a></div>
					</div>
					<div class="col-xs-12 text-center menu-1 menu-wrap">
						<ul>
							...
							<li><a href="<?= base_url('/Cabang'); ?>">Reservation</a></li>
		...
		<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner" style="background-image: url(assets/images/3.jpg);" data-stellar-background-ratio="0.5">
					...
					<div class="col-md-12 text-center">
						<div class="display-t js-fullheight">
							<div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
								<h1>The Best Chicken <em></em><em>in</em> Town</h1>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-pull-4 img-wrap animate-box" data-animate-effect="fadeInLeft">
						<img src="<?php echo base_url('assets/images/1.jpg') ?>" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co">
					</div>
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
						<div class="fh5co-item margin_top">
							<img src="<?php echo base_url('assets/images/9.jpg') ?>" class="img-responsive" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co">
					...
					<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
						<div class="fh5co-item">
							<img src="<?php echo base_url('assets/images/10.jpg') ?>" class="img-responsive" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co">
							<h3>Plecing Ayam</h3>
							<span class="fh5co-price"><sup></sup></span>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos nihil cupiditate ut vero alias quaerat inventore molestias vel suscipit explicabo.</p>
						</div>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
						<div class="fh5co-item margin_top">
							<img src="<?php echo base_url('assets/images/11.jpg') ?>" class="img-responsive" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co">
							<h3>Lele bakar</h3>
							<span class="fh5co-price"><sup></sup></span>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos nihil cupiditate ut vero alias quaerat inventore molestias vel suscipit explicabo.</p>
						</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-7 animate-box" data-animate-effect="fadeInRight">
						<blockquote>
							<p> &ldquo; Ayam goreng nelongso enaakk rek.. Bebek+Ayamnya mantap &rdquo;</p>
							<p class="author"><cite>&mdash; Teuku Wisnu</cite></p>
						</blockquote>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="fh5co-blog animate-box">
							<a href="#" class="blog-bg" style="background-image: url(assets/images/5.jpg);"></a>
							<div class="blog-text">
								<span class="posted_on">Feb. 15th 2016</span>
								<h3><a href="#">Ayam Goreng Nelongso - Borobudur</a></h3>
